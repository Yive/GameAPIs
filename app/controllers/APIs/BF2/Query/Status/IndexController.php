...
class IndexController extends ControllerBase {
    ...
    public function singleAction() {
        ...
        $cConfig['redis']['key']  = $this->config->application->redis->keyStructure->bf2->ping.$cConfig['ip'].':'.$cConfig['port'];
        ...
        if($redis->exists($cConfig['redis']['key'])) {
            ...
            if(!$response['gq_online']) {
                ...
                $output['queryPort'] = $response['gq_port_query']   ?? $cConfig['port'] + 13333;
    ...
    public function multiAction() {
        ...
        foreach ($cConfig['addresses'] as $key => $value) {
            ...
            $combinedRedis = $this->config->application->redis->keyStructure->bf2->ping.$combined;
            if($redis->exists($combinedRedis)) {
                ...
                if(!$response['gq_online']) {
                    ...
                    $output[$combined]['queryPort'] = $response['gq_port_query']    ?? $value['port'] + 13333;
